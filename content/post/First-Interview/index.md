...
description: Expectations, Experiences and Lessons.
date: 2025-10-16
slug: first-interview
image: what-makes-oneself.png
tags:
    - Life
---
...
Nothing done over the sem break. And the next semester, was a big one. Companies were gonna come looking for interns. Everybody wanted to get into the first few good companies. I knew that the competition was going to be intense. Companies like [MotorQ](https://www.motorq.com/), [D.E. Shaw](https://www.deshawindia.com/), [Barclays](https://home.barclays/), [Fidelity](https://www.fidelity.com/) would be the first few to come.  

I started daydreaming about getting into one of them.  

![daydreaming](drooling-heart_daydream.png)  

# Cope
In the last 3-4 days of my sem break, I quickly made a [portfolio](https://www.flashgrey.dev) for myself and to showcase my work. (*It turned out to be pretty corny instead of professional but I love it nonetheless*)  
...
Aiming for atleast 1-2 easy/medium or 1 hard question per day. [*(I gave up pretty quick)*](https://leetcode.com/u/flashgrey3000/)  
...
![messed up](bocchi-messed-up.png)
...
- [RSM-md-gen](https://github.com/FlashGrey3000/RSM-md-gen): A site that parses our assignment pdf and generates markdown with documentation just as our professor had instructed.
- [A3-recipes](https://github.com/FlashGrey3000/A3-Recipes): An application which can tell you what dishes you can make based on the items in your fridge.
- [NNinC](https://github.com/FlashGrey3000/NNinC): A simple neural network implementation in C that is a good source to learn the basic maths and code of NNs.  
...
![Omedetou](omedetou-evangelion.gif)
